...
![image](https://user-images.githubusercontent.com/72913881/162754582-c8c844a5-f676-4581-87de-d6e7750a8ef5.png)   
 
 분할정복 알고리즘과 재귀 호출을 이용하여 풀이한다.
 1) 나누기   
 2) 조건 만족하지 않으면 다시 1) -> 재귀호출 이용   
 3) 조건이 만족할 경우 해당 색깔의 색깔 변수 1씩 증가   
